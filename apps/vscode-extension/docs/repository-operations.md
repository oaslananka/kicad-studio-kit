...
- The Python MCP server source lives at [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) (removed from this monorepo).
- The npm launcher root was `packages/mcp-npm` (now migrated to `oaslananka/kicad-mcp-pro`).
