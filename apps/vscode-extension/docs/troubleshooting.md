...
KiCad Studio 2.8.3 supports `kicad-mcp-pro >=3.5.2 <4.0.0` and recommends the same range. If the status bar shows an incompatible server, install the matching server release, review the repository support matrix, and retry the MCP connection.
