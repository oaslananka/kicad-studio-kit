...
KiCad Studio 1.14.0 supports `kicad-mcp-pro >=3.5.2 <4.0.0` and was tested against `3.33.3`. If a connected server reports a version outside the required range, MCP-dependent commands are disabled while KiCad-only features continue to work.
