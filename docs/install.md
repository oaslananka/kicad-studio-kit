...
| kicad-mcp-pro Python server    | You want an MCP server that exposes KiCad workflows to MCP clients.                                                    | Install from PyPI or see [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro).                        |
...
The `kicad-mcp-pro` Python MCP server source has moved to [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro). Install and run instructions are available there.
