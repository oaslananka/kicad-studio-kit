...
features:
  - title: Quick install paths
    details: Install the KiCad Studio VS Code extension from the Marketplace or Open VSX. The KiCad MCP Pro server, npm launcher, and Docker image are released from oaslananka/kicad-mcp-pro.
    link: /install
