...
Copy the example into the client-owned config file. Do not rename an example file into a
live config inside this repository unless it is the documented workspace config for your
own project.
