...
The image is built from the [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) repository, runs as a non-root
...
use `Dockerfile.kicad10` from the [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) repository with an official KiCad 10 AppImage
URL.
