...
| KiCad Studio extension | `1.0.0` | [Extension changelog](kicad-studio.md) |
| kicad-mcp-pro Python server | `1.0.0` | [MCP server changelog](kicad-mcp-pro.md) |
| npm launcher | `1.0.0` | [npm launcher changelog](mcp-npm.md) |
