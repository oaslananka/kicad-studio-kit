...
- The `check_no_pcbnew.py` guard in [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro), because it names the
  forbidden API while enforcing the guard.
- The test suite in [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro), because tests may construct examples that
...
[oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) with
...
[oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) once the
