...
| --- | --- | --- | --- |
| kicad-studio | 1.15.0 | apps/vscode-extension/package.json | &gt;=3.5.2 &lt;4.0.0 |
...
| BoardReadyOps | required `>=1.2.0 <2.0.0`; tested against npm `1.38.0`; findings schema `1`; evidence bundle schema `2` | npm is the published-artifact source. Upgrade the CLI when the detected version is outside the supported range. |
