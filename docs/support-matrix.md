...
[oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) (see
...
| MCP server implementation compatibility | [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) | that repository's `compatibility.yaml` |
...
| Direct SWIG imports    | Production `pcbnew` imports are forbidden by a guard script in the [`oaslananka/kicad-mcp-pro`](https://github.com/oaslananka/kicad-mcp-pro) repo. |
...
| Current nightly smoke  | Run from [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) with a configured nightly `kicad-cli`.                            |
| KiCad 11 RC smoke      | Run from [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) once the installed prerelease reports `11.0.x`.                   |
...
- `requires-python` in the kicad-mcp-pro source (see [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro)) is the MCP server install-time floor.
...
Runtime drift is enforced by scripts in the [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro) repository.
