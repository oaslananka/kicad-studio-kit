...
- `product:mcp-server` for `oaslananka/kicad-mcp-pro` (MCP server source in a separate repository).
...
- MCP server updates: see [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro).
