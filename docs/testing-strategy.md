...
| Review evidence gate | Every pull request and review-policy change                          | Keep automated-review outcomes truthful, require bot/agent triage, and enforce medium/high-risk compensation.           | `corepack pnpm run check:review-evidence`                                                       |
...
| Review evidence policy         | `corepack pnpm run check:review-evidence`                            | `corepack pnpm run check`                                 |
