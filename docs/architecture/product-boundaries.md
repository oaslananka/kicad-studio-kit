...
| (removed — see [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro)) | Python dependencies, KiCad Python/CLI integrations, MCP protocol data                                  |
...
- `oaslananka/kicad-mcp-pro` (source lives in the [kicad-mcp repo](https://github.com/oaslananka/kicad-mcp-pro))
