...
| Python MCP server    | `oaslananka/kicad-mcp-pro` (source removed from monorepo) | sdist / wheel     | `publish-python.yml` in `oaslananka/kicad-mcp-pro` |
| MCP Registry listing | `oaslananka/kicad-mcp-pro` (source removed from monorepo) | registry metadata | `publish-mcp-registry.yml` in `oaslananka/kicad-mcp-pro` |
...
- `kicad-mcp-pro` source has moved to [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro).
