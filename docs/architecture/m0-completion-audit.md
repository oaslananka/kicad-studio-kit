...
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| Monorepo folder structure complete | `apps/vscode-extension` is the documented product root in [Repository structure](repo-structure.md). `packages/mcp-server` has been removed — source moved to [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro). GitHub issues [#49](https://github.com/oaslananka/kicad-studio-kit/issues/49) and [#56](https://github.com/oaslananka/kicad-studio-kit/issues/56) are closed.              | Complete |
