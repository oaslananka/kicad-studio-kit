...
KiCad Studio Kit is a monorepo with separate product boundaries for the VS Code extension,
the Python MCP server, the npm launcher, shared protocol schemas, examples, and governance docs.
