...
For MCP server work (source at [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro)):
...
- `packages/mcp-server/` (removed — see [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro)) for KiCad MCP Pro server and MCP Registry metadata (canonical source at [oaslananka/kicad-mcp-pro](https://github.com/oaslananka/kicad-mcp-pro)).
